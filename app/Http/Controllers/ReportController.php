...
{   
    ...
    public function generate_pdf(Request $request){
         ...
         $date =  $request->date;
          ...
          $get_data=DB::select(DB::raw("SELECT rack.brand_id,rack.printed_socks_code,rack.shop_socks_code,b.short_code as brand_name
          FROM (SELECT st.brand_id,rp.printed_socks_code,rp.shop_socks_code FROM `rack_products` rp 
