    ...
    <ul>
        ...
        <li>
            <a href="{{ route('rack.socks_return.index') }}" title="Analytics Dashboard"
                data-filter-tags="application intel analytics dashboard">
                <span class="nav-link-text" data-i18n="nav.theme_settings_layout_options"><i
                        class="fal fa-dot-circle"></i> &nbsp; Rack Socks Delete</span>
            </a>
        </li>
    </ul>
</li>
...
<li>
    ...
    <ul>
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="{{ route('account.transaction.create') }}" title="Analytics Dashboard"
                        data-filter-tags="application intel analytics dashboard">
                        <span class="nav-link-text" data-i18n="nav.theme_settings_layout_options"> <i
                                class="fas fa-money-bill-alt"></i> &nbsp;Create Transaction </span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('account.transaction.auth') }}" title="Analytics Dashboard"
                        data-filter-tags="application intel analytics dashboard">
                        <span class="nav-link-text" data-i18n="nav.theme_settings_layout_options"> <i
                                class="fas fa-money-bill-alt"></i> &nbsp; Auth transaction </span>
                    </a>
                </li>
            </ul>
        <li>
